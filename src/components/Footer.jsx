...
const Footer = () => {
  return (
    <footer className="relative bg-black overflow-hidden">
      ...
      {/* Glow orb */}
      <div className="absolute bottom-0 left-1/2 -translate-x-1/2 w-[600px] h-[200px] bg-[#2C74B3]/8 rounded-full blur-3xl" />
      ...
      <div className="relative max-w-7xl mx-auto px-6 lg:px-8">
        ...
        <div className="py-16 flex flex-col lg:flex-row lg:justify-between gap-12">
          ...
          >
            <Link to="/" className="flex items-center gap-3 mb-5">
              ...
              />
              <span className="text-xl font-bold text-white tracking-wide">Amenly</span>
            </Link>
            ...
            <div className="flex gap-2">
              {[
                ...
                <motion.a
                  key={i}
                  href="#"
                  whileHover={{ scale: 1.1, borderColor: 'rgba(44,116,179,0.6)' }}
          ...
          <div className="flex gap-16 lg:gap-24">
            ...
            <motion.div
              ...
              custom={1}
            >
              <p className="text-[#2C74B3] text-xs font-semibold uppercase tracking-[0.15em] mb-5">Product</p>
            ...
            <motion.div
              ...
              custom={2}
            >
              <p className="text-[#2C74B3] text-xs font-semibold uppercase tracking-[0.15em] mb-5">About Us</p>
              <ul className="space-y-3.5">
                {[
        ...
        >
          ...
          <a href="#docs" className="text-gray-500 hover:text-[#2C74B3] transition-colors text-xs">
            Documentation
          </a>
        </motion.div>
