...
const features = [
  ...
  },
  {
    ...
    description: 'Interactive visualization of your entire infrastructure topology and security posture.',
  },
  {
    icon: (
      <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    description: 'Receive prioritized recommendations to improve your security posture effectively.',
  },
]
  ...
  return (
    <section id="features" className="py-20 lg:py-28">
      <div className="max-w-7xl mx-auto px-6 sm:px-8 lg:px-12">
        {/* Section title — left-aligned like Moneda */}
        <motion.div
