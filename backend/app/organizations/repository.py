...
class OrganizationRepository:
    ...
    # --- Organization ---
    async def get_org_by_id(self, org_id: UUID) -> Optional[Organization]:
    ...
    async def update_org(self, org_id: UUID, data: dict) -> Optional[Organization]:
    ...
    async def get_position_by_id(self, pos_id: UUID) -> Optional[Position]:
        result = await self.session.execute(
